...
class CartPoleLearning(ModelLearningSimulation):
    ...
    def create_new_agent(self):
        ...
        self.agent = CartpoleSARSALearner(
            ...
            gamma_cautious=gamma_cautious if self.use_safety_model else None,
            lambda_cautious=lambda_cautious if self.use_safety_model else None,
            gamma_optimistic=gamma_optimistic if self.use_safety_model else None
        )
