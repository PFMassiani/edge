...
from learned_mean_agent import PickyDLQRSafetyLearner
...
class LearnedMeanSimulation(ModelLearningSimulation):
    ...
    def create_agent(self):
        ...
        gp_params = {
            ...
            'dataset_params': {'radius': self.pick_radius},
            'value_structure_discount_factor': None,
        }
        offline_learner = PickyDLQRSafetyLearner(
            env=self.env,
...
if __name__ == '__main__':
    base_path = Path(__file__).parent / 'offline_long'
    output_dir = base_path / 'models' / 'learned_mean'
    mean_number = 40
    offline_seed = 1604494254
